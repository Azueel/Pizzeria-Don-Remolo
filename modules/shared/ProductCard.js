...
export const ProductCard = ({ title, desc, oldPrice, newPrice, image }) => {
	return (
		<article className="flex flex-col gap-5 min-w-[200px] w-full max-w-[250px] min-h-[200px] h-full max-h-[340px] rounded-lg shadow-md lg:grid lg:gap-2">
			...
			<section className="flex justify-center px-3 lg:p-0">
				<button
					className="w-full max-w-[200px] h-8 text-white bg-primary rounded-[50px] active:shadow-xl lg:self-end"
					type="button"
				>
					Agregar al carrito
				</button>
